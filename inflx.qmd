...
-   **When to use it**: When you need an interpretable threshold with inference (estimate + CI) and potentially different effects below vs above the threshold. For example, tto find a biomarker level above which disease risk is higher [@chen2024]
